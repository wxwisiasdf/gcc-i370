...
#if !defined(__UDOS__) || defined(__MVS__) || defined(__CMS__) || defined(__VSE__)
#include "xm-mvs.h"
#endif
...
#if defined(__MVS__) || defined(__CMS__) || defined(__VSE__) || defined(__UDOS__)
