...
;;
;; Branching instruction pattern(s).
;;
(define_code_iterator cond [ne eq lt ltu gt gtu ge le geu leu])
(define_code_attr CC [(ne "NE") (eq "E") (lt "L") (ltu "L") 
		      (gt "H") (gtu "H") (ge "NL") (le "NH") 
		      (geu "NL") (leu "NH") ])
(define_insn "b<cond:code>"
  [(set (pc)
	(if_then_else (cond (reg CC_REGNUM)
			  (const_int 0))
...
;;
(define_code_attr rCC [(ne "E") (eq "NE") (lt "NL") (ltu "NL") 
		      (gt "NH") (gtu "NH") (ge "L") (le "H") 
		      (geu "L") (leu "H") ])
(define_insn ""
  [(set (pc)
	(if_then_else (cond (reg CC_REGNUM)
