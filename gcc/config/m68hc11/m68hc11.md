...
(define_split
  ...
  [(parallel [(set (reg:HI D_REGNUM) (match_dup 1))
   ...
   (set (reg CC_REGNUM) (reg:QI D_REGNUM))
   (parallel [(set (reg:HI D_REGNUM) (match_dup 1))
	      (set (match_dup 1) (reg:HI D_REGNUM))])]
...
(define_insn_and_split "cmphi_z_used"
  ...
  [(set (mem:HI (pre_dec:HI (reg:HI SP_REGNUM))) (match_dup 2))
   ...
   (set (reg CC_REGNUM) (compare (match_dup 0) (match_dup 1)))
...
(define_split
  ...
  [(set (match_dup 3) (match_dup 2))
   (set (reg CC_REGNUM) (and:QI (match_dup 0) (match_dup 4)))]
...
(define_insn_and_split "bitcmpqi_z_used"
  ...
  [(set (mem:HI (pre_dec:HI (reg:HI SP_REGNUM))) (match_dup 2))
   (set (match_dup 2) (match_dup 3))
   (set (reg CC_REGNUM) (and:QI (match_dup 0) (match_dup 1)))
   (set (match_dup 2) (mem:HI (post_inc:HI (reg:HI SP_REGNUM))))]
  "operands[3] = gen_rtx_REG (HImode, SOFT_Z_REGNUM);")
...
(define_peephole2
  ...
  "(X_REG_P (operands[1]) || Y_REG_P (operands[1]))
   ...
   && !reg_mentioned_p (operands[0], operands[2])"
  [(set (reg CC_REGNUM) (compare (match_dup 1) (match_dup 2)))]
  "")
...
(define_peephole2
  ...
  [(set (reg CC_REGNUM) (compare (match_dup 2) (match_dup 4)))]
  "if (INTVAL (operands[1]) == 1)
...
(define_peephole2
  ...
  "TARGET_AUTO_INC_DEC
   && (INTVAL (operands[1]) == -1 || INTVAL (operands[1]) == 1)
   && reg_mentioned_p (operands[0], operands[2])"
  [(set (reg CC_REGNUM) (compare (match_dup 4) (match_dup 3)))]
  "if (INTVAL (operands[1]) == 1)
     operands[4] = gen_rtx_MEM (QImode,
			    gen_rtx_PRE_INC (HImode, operands[0]));
   else
...
(define_peephole2
  [(set (match_operand:HI 0 "hard_reg_operand" "")
   ...
   (set (reg CC_REGNUM) (match_operand:HI 5 "hard_reg_operand" ""))]
  ...
  [(set (match_dup 2) (match_dup 1))
   ...
   (set (match_dup 4) (match_dup 2))
   (set (reg CC_REGNUM) (compare (match_dup 2) (match_dup 3)))]
  "")
...
(define_peephole
  [(set (match_operand:HI 0 "hard_reg_operand" "") (reg:HI SOFT_XY_REGNUM))
   ...
   (set (reg CC_REGNUM) (compare (match_operand:HI 2 "hard_reg_operand" "")
