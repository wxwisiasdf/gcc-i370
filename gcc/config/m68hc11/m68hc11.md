...
(define_register_constraint "t" "S_REGS"
  "A register lol")

(define_register_constraint "v" "D_REGS"
  "A register lol")

(define_register_constraint "w" "SP_REGS"
  "A register lol")
...
(define_register_constraint "D" "D_OR_X_REGS"
  "A register lol")
...
(define_register_constraint "u" "S_REGS"
  "A register lol")

(define_register_constraint "A" "A_REGS"
  "A register lol")

(define_register_constraint "B" "X_OR_Y_REGS"
  "A register lol")

(define_register_constraint "h" "ALL_REGS"
  "A register lol")
...
;; Immediates
(define_constraint "L"
  "A signed immediate in the range -65536 to 65536."
  (and (match_code "const_int")
       (match_test "IN_RANGE (ival, -65536, 65536)")))

(define_constraint "N"
  "A signed immediate in the range +1 or -1."
  (and (match_code "const_int")
       (match_test "IN_RANGE (ival, -1, 1)")))

(define_constraint "P"
  "A signed immediate in the range -8 to 2."
  (and (match_code "const_int")
       (match_test "IN_RANGE (ival, -8, 2)")))
...
(define_split
  ...
  [(parallel [(set (reg:HI D_REGNUM) (match_dup 1))
   ...
   (set (reg:HI CC_REGNUM) (reg:QI D_REGNUM))
   (parallel [(set (reg:HI D_REGNUM) (match_dup 1))
	      (set (match_dup 1) (reg:HI D_REGNUM))])]
  ...
  if (GET_CODE (operands[2]) != CONST_INT) 
    {
      ...
      emit_insn (gen_rtx_PARALLEL (VOIDmode,
	 	 gen_rtvec (2, gen_rtx_SET (operand0,
...
(define_expand "beq"
  [(set (pc)
	(if_then_else (eq (reg:CCZ CC_REGNUM)
			  (const_int 0))
		      (label_ref (match_operand 0 "" ""))
		      (pc)))]
  ""
...
(define_expand "bne"
  [(set (pc)
	(if_then_else (ne (reg:CCZ CC_REGNUM)
			  (const_int 0))
		      (label_ref (match_operand 0 "" ""))
		      (pc)))]
  ""
...
(define_expand "bgt"
  [(set (pc)
	(if_then_else (gt (reg:CCZ CC_REGNUM)
			  (const_int 0))
		      (label_ref (match_operand 0 "" ""))
		      (pc)))]
  ""
...
(define_expand "bgtu"
  [(set (pc)
	(if_then_else (gtu (reg:CCZ CC_REGNUM)
			   (const_int 0))
		      (label_ref (match_operand 0 "" ""))
		      (pc)))]
  ""
...
(define_expand "blt"
  [(set (pc)
	(if_then_else (lt (reg:CCZ CC_REGNUM)
			  (const_int 0))
		      (label_ref (match_operand 0 "" ""))
		      (pc)))]
  ""
...
(define_expand "bltu"
  [(set (pc)
	(if_then_else (ltu (reg:CCZ CC_REGNUM)
			   (const_int 0))
		      (label_ref (match_operand 0 "" ""))
		      (pc)))]
  ""
...
(define_expand "bge"
  [(set (pc)
	(if_then_else (ge (reg:CCZ CC_REGNUM)
			   (const_int 0))
		      (label_ref (match_operand 0 "" ""))
		      (pc)))]
  ""
...
(define_expand "bgeu"
  [(set (pc)
	(if_then_else (geu (reg:CCZ CC_REGNUM)
			   (const_int 0))
		      (label_ref (match_operand 0 "" ""))
		      (pc)))]
  ""
...
(define_expand "ble"
  [(set (pc)
	(if_then_else (le (reg:CCZ CC_REGNUM)
			   (const_int 0))
		      (label_ref (match_operand 0 "" ""))
		      (pc)))]
  ""
...
(define_expand "bleu"
  [(set (pc)
	(if_then_else (leu (reg:CCZ CC_REGNUM)
			   (const_int 0))
		      (label_ref (match_operand 0 "" ""))
		      (pc)))]
  ""
  ...
  "
{
  ...
  if (ret_rtx)
    ret_size = GET_MODE_SIZE (GET_MODE (ret_rtx));
  ...
  if (ret_size && ret_size <= 2)
    {
      emit_jump_insn (gen_rtx_PARALLEL (VOIDmode,
		      gen_rtvec (2, emit_jump_insn (simple_return_rtx),
...
(define_peephole2
  ...
  "(X_REG_P (operands[1]) || Y_REG_P (operands[1]))
   ...
   && !reg_mentioned_p (operands[0], operands[2])"
  [(set (reg:CCZ CC_REGNUM) (compare (match_dup 1) (match_dup 2)))]
  "")
...
(define_peephole2
  ...
  "TARGET_AUTO_INC_DEC
   && (INTVAL (operands[1]) == -1 || INTVAL (operands[1]) == 1)
   && reg_mentioned_p (operands[0], operands[2])"
  [(set (reg:CCZ CC_REGNUM) (match_dup 3))]
...
(define_peephole2
  ...
  [(set (reg:CCZ CC_REGNUM) (compare (match_dup 2) (match_dup 4)))]
  "if (INTVAL (operands[1]) == 1)
...
(define_peephole2
  ...
  "TARGET_AUTO_INC_DEC
   && (INTVAL (operands[1]) == -1 || INTVAL (operands[1]) == 1)
   && reg_mentioned_p (operands[0], operands[2])"
  [(set (reg:CCZ CC_REGNUM) (compare (match_dup 4) (match_dup 3)))]
  "if (INTVAL (operands[1]) == 1)
     operands[4] = gen_rtx_MEM (QImode,
			    gen_rtx_PRE_INC (HImode, operands[0]));
   else
...
(define_peephole2
  [(set (match_operand:HI 0 "hard_reg_operand" "")
   ...
   (set (reg:CCZ CC_REGNUM) (match_operand:HI 5 "hard_reg_operand" ""))]
  ...
  [(set (match_dup 2) (match_dup 1))
   ...
   (set (match_dup 4) (match_dup 2))
   (set (reg:CCZ CC_REGNUM) (compare (match_dup 2) (match_dup 3)))]
  "")
...
(define_peephole
  [(set (match_operand:HI 0 "hard_reg_operand" "h")
   ...
   (set (match_operand:HI 2 "hard_reg_operand" "h")
        (match_dup 0))]
  "peep2_reg_dead_p (REGNO (operands[0]), insn)
   && !S_REG_P (operands[2])"
  "*
{
  rtx ops[2];
...
(define_peephole
  [(set (match_operand:HI 0 "hard_reg_operand" "") (reg:HI SOFT_XY_REGNUM))
   ...
   (set (reg:CCZ CC_REGNUM) (compare (match_operand:HI 2 "hard_reg_operand" "")
