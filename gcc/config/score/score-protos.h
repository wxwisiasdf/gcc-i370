...
extern HOST_WIDE_INT score_constant_alignment (const_tree exp, HOST_WIDE_INT basic_align);
extern unsigned int score_hard_regno_nregs (unsigned regno, machine_mode mode);
extern bool score_modes_tieable_p (machine_mode mode1, machine_mode mode2);
extern HOST_WIDE_INT score_starting_frame_offset(void);
